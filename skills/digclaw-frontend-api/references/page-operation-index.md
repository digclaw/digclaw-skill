...
| UI page | `activeMenu` | Current component | Permission label | Permission key | Page guide |
|---|---:|---|---|---|---|
...
python scripts\check_permission.py --page smart-search.company-search
python scripts\check_permission.py --page admin-accounts
```

For full rules, read `permission-policy.md`. If the helper denies access, do not call the requested page's backend APIs.
